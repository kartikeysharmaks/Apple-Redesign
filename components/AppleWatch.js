    ...
    <div className="rounded-lg">
      ...
      <div className="relative flex justify-center h-[68vh] md:h-[86vh] overflow-hidden pt-4">
        ...
        <div className="lg:hidden absolute h-[70vh] flex  z-0">
          <Image src={watch} className="object-cover" alt="applewatch" />
        </div>

        {/* Bg desktop */}
        <div className="hidden md:absolute md:flex h-[70vh] rounded-lg md:h-[90vh] z-0 bg-red-400 ">
          <Image src={watchweb} className="object-cover rounded-lg" alt="watchweb" />
        </div>
        ...
        <div className="flex flex-col items-center z-20 md:pt-8">
          <div className="text-black relative  font-semibold text-[35px] md:text-[60px] pb-10">
            <Image src={watchultra} className="object-cover" alt="watchultra"/>
          </div>
