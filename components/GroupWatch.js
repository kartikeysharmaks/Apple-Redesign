  ...
  return (
    <div className="md:w-1/2  ">
      <div className="relative flex justify-center h-[68vh] md:h-[86vh]   overflow-hidden pt-4">
        {/* Bg mobile */}
        <div className="md:hidden absolute h-[70vh] flex rounded-xl z-0 -mt-12">
          <Image src={groupwatch} className="object-cover rounded-xl" alt="" />
        </div>

        {/* Bg desktop */}
        <div className="hidden md:absolute md:flex h-[70vh] rounded-3xl md:h-[70vh] z-0 bg-red-400  ">
          <Image src={groupwatch} className="object-cover rounded-3xl" alt=""/>
        </div>
        ...
        <div className="flex flex-col items-center z-20 md:pt-8 text-black">
          <div className="relative  font-semibold text-[35px] md:text-[60px] pt-4 ">
            <Image src={watchse} className="object-cover" alt=""/>
          </div>
